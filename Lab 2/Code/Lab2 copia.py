...
file = './michele.jpeg'  # file to be analyzed
...
print(Perimeter_mole/Perimeter_circle)

# with open("output_data.xml", "a") as out_file:
#     out_string = "\n"
#     out_string += str(image) + ": "
#     out_string += "," + str(Perimeter_mole)
#     out_string += "," + str(Perimeter_circle)
#     out_string += "," + str(Perimeter_mole/Perimeter_circle)
#     out_string += "\n"
